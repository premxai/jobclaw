...
def parse_url_for_ats(link: str) -> tuple[str, str, str]:
    ...
    try:
        if "greenhouse.io" in link:
            ...
            if not slug or slug == "embed": return None, None, None
            ...
            if not slug: return None, None, None
            ...
            if slug == "api": return None, None, None
            if not slug: return None, None, None
...
def fetch_and_merge():
    ...
    if local_jobs.exists():
        ...
        try:
            with open(local_jobs, "r", encoding="utf-8", errors="ignore") as f:
                text = f.read()

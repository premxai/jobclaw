...
export default function JobRow({ job }: JobRowProps) {
  return (
    <article className="group grid h-[clamp(52px,calc((100dvh-132px)/12),72px)] grid-cols-[minmax(0,1fr)_auto] items-center gap-4 border-b border-[rgba(139,94,52,0.15)] px-5 transition-colors duration-200 last:border-b-0 hover:bg-[#FFF8EC] sm:px-7">
